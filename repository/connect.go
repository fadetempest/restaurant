...
func (base *DishRepo) AddNewValue(dish *meals.Dish) (string, error){
...
func (base *DishRepo) UpdateValue(dish *meals.Dish) (string,error){
...
func (base *DishRepo) AddNewUser(newUser meals.User) (string,error){
...
func (base *DishRepo) GetUserFromBase(user meals.User) (string, string, error){
